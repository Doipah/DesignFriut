...
const Homekupascreen = () => {
  ...
  return (
    <View style={[Style.viewbgall,{}]}>
      {/* location city */}
      {/* <Animated.View
        style={[Style.viewlocation, {transform: [
          { translateY: translation },
        ],}]}> */}

      <Animated.View
      style={{ backgroundColor: 'red', height: this.state.height }}>
        <TouchableOpacity
          onPress={() => {
            alert('location');
          }}
      ...
      <Animated.ScrollView scrollEventThrottle={16} onScroll={this.handleScroll.bind(this)}>
      {/* <Animated.ScrollView
