  ...
  _renderItem = ({item, index}) => {
    return (
        <View style={{borderWidth:1  }}>
          <View>
          <Image style={Style.viewtop1} source={{uri:'https://katalyst.kasikornbank.com/SiteCollectionDocuments/assets/page/blog/img/food-tech-technology-changes-the-world/food-tech-cover.jpg'}} />
          </View>
          <View>
