        ...
        <View
          ...
          <View
            ...
            <View style={{flexDirection:'row',marginHorizontal:23}}> 
                <View style={{justifyContent:'center', backgroundColor:COLORS.bgGrreenon,width:wp('15%'),height:wp('13%')}}>
                    <Icon1 style={{alignSelf:'center'}} name="email" size={35} color={COLORS.bgGrreen}/>
                </View>
