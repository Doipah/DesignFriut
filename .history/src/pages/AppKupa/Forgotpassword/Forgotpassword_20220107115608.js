          ...
          <TouchableOpacity
            ...
            <View style={{flexDirection: 'row', marginHorizontal: 23}}>
              ...
              <View style={{marginLeft: 20, marginTop: 10}}>
                ...
                <Text style={{fontWeight: '500',color: COLORS.colortext}}>{'Send to your email'}</Text>
              </View>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            style={{
              borderWidth: 1,
              borderColor: choose ===2? COLORS.bgGrreen:COLORS.bgcolortext,
              height: 80,
              borderRadius: 8,
              backgroundColor:  COLORS.bgcolortext,
              justifyContent: 'center',
            ...
            <View style={{flexDirection: 'row', marginHorizontal: 23}}>
              <View
                style={{
                  justifyContent: 'center',
                  backgroundColor: choose ===2?  COLORS.bgGrreenon:COLORS.white,
                  width: wp('15%'),
                  height: wp('15%'),
                  borderRadius: 35,
                }}>
                <Icon1
                  ...
                  name="phone"
                  size={35}
                  color={ choose ===2? COLORS.bgGrreen: COLORS.colortext}
                />
              </View>
              <View style={{marginLeft: 20, marginTop: 10}}>
                <Text style={{fontWeight: '600', marginBottom: 5}}>
                ...
                <Text style={{ fontWeight: '500' ,color: COLORS.colortext}}>{'Send to your phone number'}</Text>
              </View>
            </View>
          </TouchableOpacity>
