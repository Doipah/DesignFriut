    ...
    <SafeAreaView style={[{backgroundColor: COLORS.white, flex: 1}]}>
      <View style={{flex: 1, marginHorizontal: 15,}}>
        ...
        <View style={{marginTop:45}}>
            <Text style={{textAlign:'',marginBottom:10,fontWeight:'600',fontSize:23}} >
                {'Forgot Password'}
            </Text>
            <Text style={{textAlign:'',color:COLORS.colortext,marginBottom:5}} >
                {'Select which contact details should we use to reset your password'}
            </Text>
           
        </View>
        <View style={{marginTop:35,marginBottom:40,borderWidth:1,flex:1}}>

            <View style={{borderWidth:1,borderColor:COLORS.bgGrreen,height:80,borderRadius:8,backgroundColor:COLORS.bgcolortext}}>
