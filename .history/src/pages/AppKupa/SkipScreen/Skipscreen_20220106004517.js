  ...
  _renderItem = ({item}) => {
    return (
      <View style={{borderWidth: 1, flex: 1}}>
        <View
          style={{borderWidth: 1, marginBottom: 20, justifyContent: 'center'}}>
          <Image
            style={{
              height: hp('40%'),
              width: wp('100%'),
  ...
  return (
    <SafeAreaView style={[{backgroundColor: COLORS.white, flex: 1}]}>
      <View style={{flex: 1, borderWidth: 1}}>
        ...
        <View style={{borderWidth: 1, flex: 0.35, borderColor: 'red',marginHorizontal:20}}>
          <TouchableOpacity
            style={{
            ...
            <Text style={{color:COLORS.white,fontSize:16,fontWeight:'600',textAlign:'center'}}>{'Continue'}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
