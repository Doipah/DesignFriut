    ...
    <SafeAreaView style={[{backgroundColor: COLORS.white, flex: 1}]}>
      <View style={{flex: 1, marginHorizontal: 15}}>
        ...
        <TouchableOpacity
          ...
          <Text style={{color: COLORS.bgGrreen,fontWeight:'500'}}>{'Forget Password?'}</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{
        ...
        <View style={{justifyContent:'center',flexDirection:'row',marginBottom:25}}>
          ...
          <TouchableOpacity>
            <Text style={{fontWeight:'500',color:COLORS.bgGrreen}}>{"Sign Up"}</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={{flexDirection:'row',flex:0.7}}>
            <View style={{ height:hp('0.1%'), width:wp('40%'), borderWidth:0.5 , borderColor:COLORS.colortext,justifyContent:'center'}}></View>
            <Text style={{marginHorizontal:9, marginTop:-9, color:COLORS.colortext}}>{'Or with'}</Text>
            <View style={{ height:hp('0.1%'), width:wp('50%'), borderWidth:0.5 , borderColor:COLORS.colortext,justifyContent:'center'}}></View>
        </View>
    </SafeAreaView>
  );
};
