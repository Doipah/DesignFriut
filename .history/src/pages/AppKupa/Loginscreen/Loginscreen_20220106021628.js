    ...
    <SafeAreaView style={[{backgroundColor: COLORS.white, flex: 1}]}>
      <View style={{borderWidth:1, flex: 1, marginHorizontal:10}}>
          ...
          <View style={{borderWidth:1,marginBottom:20}}>
              <Text style={{fontSize:15  ,color:COLORS.colortext}}> {'Sing to your account'}</Text>
          </View>
          ...
          <View style={{borderWidth:1}}>
              ...
              <View style={{borderWidth:1,backgroundColor:COLORS.colortext,height:40,borderRadius:10}}>
                  <TextInput value='' placeholder='Your Email'/>
              </View>
          </View>
