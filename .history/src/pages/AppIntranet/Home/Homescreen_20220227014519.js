...
const listDamenu = ({item, index}) => {
  return (
    <View style={{marginVertical:10, borderColor: 'red', borderWidth: 1, marginHorizontal: 20}}>
      <TouchableOpacity style={{flex: 1, height:100, width: 120}}>
          <View>
          <Image
...
const styles = StyleSheet.create({
  ...
  imglogo: {resizeMode: 'contain', width: 70},
  LIcssview1: {
    flex: 1,
