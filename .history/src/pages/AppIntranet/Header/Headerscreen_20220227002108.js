      ...
      <LinearGradient
        ...
        <View style={{ marginHorizontal: 10, flexDirection: 'row'}}>
          <View style={{borderWidth: 1, flex: 1}}>
            <Text style={{marginBottom:3, fontSize: fontSizes.TittleSize, color: COLORS.white}}>
              {'Hello !'}
            </Text>
          ...
          <View style={{ borderRadius:20, width:45,  borderWidth:1,backgroundColor:COLORS.white}}>
          <Image
...
const styles = StyleSheet.create({
  ...
  imglogo: {borderRadius:20, width:45, height:45, resizeMode: 'contain',},
  LIcssview1: {
    flex: 1,
