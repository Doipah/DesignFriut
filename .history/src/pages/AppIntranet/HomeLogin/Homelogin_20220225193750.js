          ...
          <View style={styles.Viewfromlogin1}>
            <View style={styles.Viewfromlogin2}>
              ...
              <LinearGradient
                ...
                <TouchableOpacity style={{height: 35, borderRadius: 7,justifyContent:'center'}}>
                  <Text style={{fontWeight:'bold', fontSize:fontSizes.labelSize, color:COLORS.white, textAlign:'center',}}>{'LOGIN'}</Text>
                </TouchableOpacity>
              </LinearGradient>
            </View>
          </View>
