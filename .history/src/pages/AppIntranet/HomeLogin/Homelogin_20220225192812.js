            ...
            <View style={styles.Viewfromlogin2}>
              ...
              <View style={{ flexDirection: 'row',justifyContent:'center'}}>
                <View style={{ flexDirection: 'row', flex: 1,}}>
                  ...
                  <Text style={{ fontSize:fontSizes.labelSize,marginLeft:5, color: COLORS.placeholderTextColor,}}>
                    {'Save my user'}
                  </Text>
                </View>
                <View style={{ flexDirection: 'row', flex: 1,justifyContent:'flex-end'}}>
                  <TouchableOpacity>
                    <Text style={{color:COLORS.bglinearblue,fontSize:fontSizes.labelSize}}>{'Forget password ?'}</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
