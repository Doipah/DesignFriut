...
const Profiles = () => {
  ...
  return (
    <View style={[Style.viewbgall, {borderWidth: 1}]}>
      {/* location city */}

      <Animated.View style={[Style.viewlocation,{marginHorizontal:10}]}>
        <View style={{flexDirection: 'row', flex: 1,borderWidth:1}}>
          <View style={{justifyContent: 'center'}}>
            <Text style={Style.Textcss1}>{'MY NAME'}</Text>
          </View>
        </View>

        {/* Time  */}
        <View style={[Style.viewbgtime,{borderWidth:1}]}>
