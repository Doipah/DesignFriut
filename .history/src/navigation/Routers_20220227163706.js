      ...
      <Tabs.Navigator
        ...
        <Tabs.Screen
          ...
          options={{
            tabBarLabel: () => <View />,
            tabBarIcon: () => (
              <View style={{marginTop:-40, borderRadius:50, height:80,width:80,backgroundColor:COLORS.bggray}}>
              <View style={{backgroundColor:COLORS.bglinearblue ,marginTop:-40, borderRadius:50, height:80,width:80, }}>
                <Image
                  style={{resizeMode: 'contain', width: 30, height: 30}}
