      ...
      <Tabs.Navigator
        ...
        <Tabs.Screen
          ...
          options={{
            tabBarLabel: () => <View />,
            tabBarIcon: () => (
              <View style={{justifyContent:'center', marginTop:-40, borderRadius:50, height:80,width:80,backgroundColor:COLORS.bggray}}>
              <View style={{alignSelf:'center', justifyContent:'center', backgroundColor:COLORS.bglinearblue , borderRadius:50, height:70,width:70, }}>
                <Image
                  style={{alignSelf:'center', resizeMode: 'contain', width: 30, height: 30}}
